import { ArrowRightLeft, CircleEllipsis, Home, Users } from "lucide-react"
...
export function TabBar() {
  ...
  return (
    <nav aria-label="Primary" className="fixed inset-x-0 bottom-0 z-50">
      <div className="mx-auto w-full box-border px-2 pb-[calc(env(safe-area-inset-bottom,0px)+28px)] sm:px-5 md:px-8">
